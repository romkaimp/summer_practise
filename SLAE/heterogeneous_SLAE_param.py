"""неоднородная СЛАУ с параметром"""
import logging
...
def generate_random_matrix(rows, cols, k, lmb, seed=seed_value, start_variant=start_variant) -> (np.ndarray, np.ndarray):
...
if __name__ == "__main__":
    ...
    n = 1  # int(input())
    lmb = 1
    print(generate_random_matrix(r - n, r, k, lmb))